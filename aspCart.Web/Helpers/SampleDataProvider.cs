...
namespace aspCart.Web.Helpers
{
    public static class SampleDataProvider
    {
        ...
        private static async Task TestDataSeed(ApplicationDbContext context, IConfiguration configuration)
        {
            ...
            {
                new Order { Id = OrderIds.Order1.GetGuid(), OrderNumber = "662-347-330787", UserId = AccountIds.User1.GetGuid(), BillingAddressId = BillingAddressIds.Billing1.GetGuid(), TotalOrderPrice = 750.00m, Status = (OrderStatus)2, OrderPlacementDateTime = DateTime.Now, OrderCompletedDateTime = DateTime.Now },
            ...
            {
                new OrderItem { OrderId = OrderIds.Order1.GetGuid(), ProductId = ProductIds.AcerPredatorGx.GetGuid().ToString(), Name = "Acer Predator GX-792-77BL 17.3\" 4K/UHD Intel Core i7 7th Gen 7820HK (2.90 GHz) NVIDIA GeForce GTX 1080 32 GB Memory 512 GB SSD 1 TB HDD Windows 10 Home 64-Bit Gaming Laptop", Quantity = 1, Price = 750.00m, TotalPrice = 750.00m },
