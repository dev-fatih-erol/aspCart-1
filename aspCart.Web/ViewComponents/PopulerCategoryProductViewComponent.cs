...
{
    [ViewComponent(Name = "PopulerCategoryProduct")]
    public class PopulerCategoryProductViewComponent : ViewComponent
    {
        private readonly IProductService _productService;
        private readonly IReviewService _reviewService;
        private readonly IMapper _mapper;

        public PopulerCategoryProductViewComponent(IProductService productService,
