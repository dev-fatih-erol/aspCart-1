...
{
    [ViewComponent(Name = "RecommendationForYou")]
    public class RecommendationForYouViewComponent : ViewComponent
    {
        private readonly IProductService _productService;
        private readonly IReviewService _reviewService;
        private readonly IMapper _mapper;

        public RecommendationForYouViewComponent(IProductService productService,
