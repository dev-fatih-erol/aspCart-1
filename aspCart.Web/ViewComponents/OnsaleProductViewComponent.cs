...
{
    [ViewComponent(Name = "OnsaleProduct")]
    public class OnsaleProductViewComponent : ViewComponent
    {
        private readonly IProductService _productService;
        private readonly IReviewService _reviewService;
        private readonly IMapper _mapper;

        public OnsaleProductViewComponent(IProductService productService,
        ...
        public IViewComponentResult Invoke()
        {
            var productEntities = _productService.GetAllProducts()
                .Where(x => x.Published == true && x.SpecialPriceEndDate != null && x.SpecialPriceEndDate >= DateTime.Now)
